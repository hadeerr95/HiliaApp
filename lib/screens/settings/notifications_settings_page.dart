            ...
            children: <Widget>[
              ...
              Flexible(
                child: ListView(
                  children: <Widget>[
                    ListTile(
                      title: AutoSizeText('My orders'),
                      trailing: platformSwitch(myOrders),
                    ),
                    ListTile(
                      title: AutoSizeText('Reminders'),
                      trailing: platformSwitch(reminders),
                    ),
                    ListTile(
                      title: AutoSizeText('New Offers'),
                      trailing: platformSwitch(newOffers),
                    ),
                    ListTile(
                        title: AutoSizeText('Feedbacks and Reviews'),
                        trailing: platformSwitch(
                          feedbackReviews,
                        )),
                    ListTile(
                      title: AutoSizeText('Updates'),
