...
class QuickSendAmountPage extends StatelessWidget {
  ...
  const QuickSendAmountPage({Key key, @required this.id}) : super(key: key);
        ...
        appBar: AppBar(
          ...
          actions: <Widget>[
            IconButton(
              ...
              onPressed: () =>
                  Navigator.of(context).push(ReceivePaymentPage.route()),
            )
          ],
