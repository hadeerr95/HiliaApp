...
class _TrackingPageState extends State<TrackingPage> {
  ...
  String selectedProduct = 'Boat firstScreen Bass boost 100v';
                    ...
                    Container(
                      ...
                      child: DropdownButtonHideUnderline(
                        child: DropdownButton(
                          items: <String>[
                            'Boat firstScreen Bass boost 100v',
                            'Boat firstScreen Bass boost 200v',
                            'Boat firstScreen Bass boost 300v',
                            'Boat firstScreen Bass boost 400v',
                            'Boat firstScreen Bass boost 500v',
                            'Boat firstScreen Bass double boosting 600v'
                          ].map((val) {
                              ...
                              ...locations
                                  .map(
                                    (location) => Step(
                                      ...
                                      title: AutoSizeText(location.city),
                                      subtitle:
                                          AutoSizeText(location.getDate()),
                                      content: Align(
                                        child: Image.asset(
