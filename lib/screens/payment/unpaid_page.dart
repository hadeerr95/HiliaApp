...
import 'package:app/screens/payment/promo_item.dart';
                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  ListTile(
                                    title: AutoSizeText(
                                        'Boat Rockerz 350 On-Ear ..'),
                                    trailing: AutoSizeText('74.68'),
                                  ),
                                  ListTile(
                                    title: AutoSizeText('Taxes'),
                                    trailing: AutoSizeText('1.25'),
                                  ),
                                  ListTile(
                                    title: AutoSizeText('Subtotal'),
                                    trailing: AutoSizeText('76.93'),
                                  ),
                                  ListTile(
                                    title: AutoSizeText('Promocode'),
                                    trailing: AutoSizeText('-10.93'),
                                  ),
                                  Divider(),
                                  ListTile(
                                    title: AutoSizeText(
