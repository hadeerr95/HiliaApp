...
class SelectCardPage extends StatelessWidget {
  static Route route() {
    return MaterialPageRoute<void>(builder: (_) => SelectCardPage());
  }
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        Spacer(),
                        AutoSizeText('4452 - 8645 - 4524 - 2413',
                            style: TextStyle(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Row(
                            ...
                            children: [
                              AutoSizeText('This will be deducted',
                                  style: TextStyle(
                                      color: Colors.grey, fontSize: 10.0)),
                              Row(
                                mainAxisSize: MainAxisSize.min,
